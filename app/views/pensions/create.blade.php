  ...
  <form id="form">
    <fieldset>
      ...
      <input type="submit" tabindex="-1" style="position:absolute; top:-1000px">
         ...
         <form method="POST" action="{{{ URL::to('pensions') }}}" accept-charset="UTF-8">
  
    <fieldset>

       <div class="form-group">
                        <label for="username">Employee <span style="color:red">*</span></label>
                        <select name="employee" id="employee" required="" class="form-control select2">
                           <option></option>
        ...
        <input class="form-control" placeholder="" type="hidden" name="emp" id="emp" >

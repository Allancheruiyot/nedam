          ...
          <span aria-hidden="true">&times;</span>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                          <a class="btn btn-info btn-sm" href="{{ URL::to('statement/report')}}">View Statements</a><br><br>
                    ...
                    @foreach ($deductions as $key => $deduction)
                     ...
                     <?php if($year!=$deduction->year){$i=0;$year=$deduction->year;} 
                      ...
                      <tr>                      
                          ...
                          <td> {{ number_format(floatval( Pensioninterest::getTransactInterest($deduction->employee_id,$deduction->financial_month_year)),2)  }}</td>
                          <td> {{ number_format(floatval( $deduction->employee_amount+$deduction->employer_amount+Pensioninterest::getTransactInterest($deduction->employee_id,$deduction->financial_month_year)),2)  }}</td>                         
                          <td>{{ Pensioninterest::getTransactComment($deduction->employee_id,$deduction->financial_month_year) }}</td>                         
